...
absinta = pd.read_csv(os.path.join(stats_dir, 'absinta.csv'))
schirmer = pd.read_csv(os.path.join(stats_dir, 'schirmer.csv'))
...
df.to_csv(os.path.join(stats_dir, 'stats.csv'), index=False)
...
df['adj_pval'] = fdrcorrection(df['pval'])[1]
df.to_csv(os.path.join(stats_dir, 'stats2.csv'), index=False)
